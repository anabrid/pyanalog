...
#include <cfenv> /* for feenableexcept and friends */
...
%(state_type)s simulate_dda(%(state_type)s initial, int max_iterations, int modulo_writer, int rk_order) {
    ...
    // TODO: Should use standard C++ <fenv> interface for raising C++ exceptions when
    //       illegal floating point opperations occur.
    if(debug) {
#ifdef __GNUC__
