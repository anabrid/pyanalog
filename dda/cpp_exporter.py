...
def run(command="./a.out", return_ndarray=True, return_recarray=False, arguments={}, fields_to_export=[], binary=False):
    """
    ...
    with column headers. ``return_recarray=True`` implies ``return_ndarray=True`` and only works
    if you pass ``fields_to_export``.
    ...
    # FIXME: Python 3.6 does not yet have the text keyword. Newer Pythons have. Find something
    #        compatible.
